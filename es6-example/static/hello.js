...
var defautLine = "Starts your journey now!!!";
var BR = "<br />";

function addToOutput() {
	var newLine = arguments.length <= 0 || arguments[0] === undefined ? defautLine : arguments[0];
...
var Angel = exports.Angel = function (_Encounter2) {
	...
	function Angel() {
		...
		return _possibleConstructorReturn(this, Object.getPrototypeOf(Angel).call(this, "grr grow, you encountered a Angel! This will give you strength and healing possibilities"));
	}
...
var Environment = exports.Environment = function () {
	...
	_createClass(Environment, [{
		...
		value: function stumbleUpon() {
			...
			var interaction = this.name + "you just stumble upon .... " + this.encounter.whenEncounter();
...
function findTreasure() {
	...
	if (findCoords) {
		...
		(0, _addition.addToOutput)('you found {name} ( {value}');
	}
}
...
function onClickEnter() {
	...
	if (commands.value == "help") {
		...
		navigate(-1, 0);
		(0, _addition.addToOutput)(environment.stumbleUpon());
		...
		(0, _addition.addToOutput)(environment.poke());
	} else {
		(0, _addition.addToOutput)(commands);
	}
}
...
var list = [1, 2, 4, "", 5];
var multiplyList = new _multiply_list.MultiplyList(list, 2);
...
},{"./addition.js":1,"./encounter.js":2,"./environment.js":3,"./multiply_list.js":5}],5:[function(require,module,exports){
"use strict";
...
},{"babel-core/register":6,"babel-polyfill":7}],6:[function(require,module,exports){
/* eslint max-len: 0 */
...
},{"core-js/fn/regexp/escape":9,"core-js/shim":302,"regenerator-runtime/runtime":304}],8:[function(require,module,exports){
"use strict";
